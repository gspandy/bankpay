...
<head>
    ...
    <script type="text/javascript">
        function ajaxSumbit() {
            $.ajax({
                type: 'get',
                url: 'http://lemon613.ticp.net/bankpay/bank/industrialWXScanPay',
...
<div>
    <form id="form_query" method="post">
        service: <input type="text" name="service" value="pay.weixin.native" id="service"/></br>
        ...
        通知地址：<input name="notify_url" value="http://lemon613.ticp.net/bankpay/bank/industrialWXScanCallBack"/>
        <div id="lastdiv"></div>
